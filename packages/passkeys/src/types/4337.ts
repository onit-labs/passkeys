// ! borrowed from https://github.com/alchemyplatform/aa-sdk/blob/9fbc86cc2c67bfd445668e0ed485acbc69960488/packages/core/src/types.ts
import type {
	Address,
	Chain,
	Client,
...
export type UserOperationOverrides = Partial<
	Pick<UserOperationStruct, "maxFeePerGas" | "maxPriorityFeePerGas" | "paymasterAndData">
>;
...
// ! borrowed from https://github.com/alchemyplatform/aa-sdk/blob/9fbc86cc2c67bfd445668e0ed485acbc69960488/packages/core/src/client/types.ts
